...
contract('ProviderRegistryGetExpectedRateTest', (accounts) => {
    ...
    withData({
        ...
        //Fix _6_Uniswap_OMG_to_15_DAI: [stablepayProviders.Uniswap, 'OMG', '15', 'DAI', true],
        _7_Kyber_OMG_to_31_DAI: [stablepayProviders.Kyber, 'OMG', '31', 'DAI', true],
        //Fix _7_Uniswap_OMG_to_31_DAI: [stablepayProviders.Uniswap, 'OMG', '31', 'DAI', true],
        ...
        //Fix _11_Uniswap_SNT_to_41_DAI: [stablepayProviders.Uniswap, 'SNT', '41', 'DAI', true],
