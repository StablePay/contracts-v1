...
contract CustomUniswapExchangeMock is UniswapExchangeInterface {
    ...
    constructor(uint256 _ethToTokenInput, uint256 _ethToTokenOutput, uint256 _tokenToEthInput, uint256 _tokenToEthOutput) public {
    ...
    external
    returns (uint256 tokens_bought) {
        min_tokens_bought; min_eth_bought; deadline; token_addr;
        return tokens_sold;
    }
    ...
    external
    returns (uint256  tokens_bought) {
        min_tokens_bought; min_eth_bought; deadline; recipient; token_addr;
        return tokens_sold;
    }
    ...
    external
    returns (uint256  tokens_sold) {
        max_tokens_sold; max_eth_sold; deadline; token_addr;
        return tokens_bought;
    }
    ...
    external
    returns (uint256  tokens_sold) {
        max_tokens_sold; max_eth_sold; deadline; recipient; token_addr;
        return tokens_bought;
    }
    ...
    external
    returns (uint256  tokens_bought) {
        min_tokens_bought; min_eth_bought; deadline; exchange_addr;
        return tokens_sold;
    }
    ...
    external
    returns (uint256  tokens_bought) {
        min_tokens_bought; min_eth_bought; deadline; recipient; exchange_addr;
        return tokens_sold;
    }
    ...
    external
    returns (uint256  tokens_sold) {
        max_tokens_sold; max_eth_sold; deadline; exchange_addr;
        return tokens_bought;
    }
    ...
    external
    returns (uint256  tokens_sold) {
        max_tokens_sold; max_eth_sold; deadline; recipient; exchange_addr;
        return tokens_bought;
    }
